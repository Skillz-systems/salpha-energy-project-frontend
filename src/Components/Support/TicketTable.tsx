...
const generateTicketEntries = (data: any): TicketEntries[] => {
  const entries: TicketEntries[] = data?.tickets.map(
...
const TicketTable = ({
  ...
  const filterList = [
    ...
    {
      name: "All Category",
      items: ["All Category", "Active Agents", "Reported Agents", "Barred Agents"],
  ...
  const getTableData = () => {
    return generateTicketEntries(ticketData);
  };
